...
class QuickStartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: ZVColors.background, // ✅ sfondo riposante
      appBar: AppBar(
        backgroundColor: ZVColors.background, // ✅ non bianco sparato
        elevation: 0,
        toolbarHeight: 74,
        titleSpacing: 16,
        centerTitle: true,

        // ✅ Titolo centrato davvero + logo a sinistra
        title: Stack(
        ...
        // ✅ linea gialla soft (non evidenziatore)
